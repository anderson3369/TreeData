...
class PlantedDatePickerFragment: DialogFragment(), DatePickerDialog.OnDateSetListener {
    ...
    override fun onDateSet(p0: DatePicker?, p1: Int, p2: Int, p3: Int) {
        ...
        setFragmentResult("requestDateKey", bundleOf("plantedDate" to DateConverter().fromOffsetDate(date)))
    }
}