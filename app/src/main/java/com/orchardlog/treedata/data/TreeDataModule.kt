...
class TreeDataModule {
    ...
    @Provides
    fun providesOrchardWithOrchardActivitiesDao(orchardDatabase: OrchardDatabase): OrchardWithOrchardActivitiesDao {
        return orchardDatabase.orchardWithOrchardActivitiesDao()
    }

    @Provides
    fun providesFarmWithOrchardsWithOrchardActivities(orchardDatabase: OrchardDatabase): FarmWithOrchardsWithOrchardActivitiesDao {
        return orchardDatabase.farmWithOrchardsWithOrchardActivities()
    }
}